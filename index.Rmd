...
column(width = 12,
    ...
    column(width = 4,
          ...
          # select species to show
          selectInput("spmapbs", "Choose species:", choices = list('arroyo chub' = 'chub', 'arroyo toad' = 'toad', "least bell's vireo" = 'vireo', 'rainbow trout' = 'trout', 'santa ana sucker' = 'sucker', 'southwestern pond turtle' = 'turtle'))
