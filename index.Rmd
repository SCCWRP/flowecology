...
output$bsprdsmap <- downloadHandler(
...
output$futprdsmap <- downloadHandler(
...
```
```{r}
column(12, downloadButtonRmd('dlspmap', 'Download map'))
HTML('<br>')
column(12, 
...
```{r}
column(12, downloadButtonRmd('dlbsprdsmap', 'Download map'))
HTML('<br>')
column(12, 
...
```{r}
column(12, downloadButtonRmd('dlbsprdsdst', 'Download figure'))
column(12, plotOutput('bsprdsdst') %>% withSpinner())
column(12, downloadButtonRmd('dlbsprdstab', 'Download table'))
...
```{r}
column(12, downloadButtonRmd('dlfutprdsmap', 'Download map'))
HTML('<br>')
column(12, 
...
```{r}
column(12, downloadButtonRmd('dlfutprdsdst', 'Download figure'))
column(12, plotOutput('futprdsdst') %>% withSpinner())
column(12, downloadButtonRmd('dlfutprdstab', 'Download table'))
