...
jeopCorpus <- readLines('emails.md') %>% 
  VectorSource %>% 
  Corpus
...
wordcloud(jeopCorpus, max.words = 50, random.order = FALSE)
```
...
### Sabrina Drill phone call 6/22

Biologist with UC coop extension, ag and natural resources covering LA and Ventura county, fish biologist by training, natural resources advisory by career

Needs: 

- Focus on how changes in flow/precip by location affect __stream habitat__, hydrogeomorphological changes, particularly sedimentation and substrate changes as related to salmonid habitat

- Impacts of fire and relation to climate, how will climate change increase severity/occurrence of fires and what does that mean for streams 

- Approach to prioritize barrier removal projects - can we develop an app that lets of evaluate connectivity of stream networks and how doe sthat relate to climate change
